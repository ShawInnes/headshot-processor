...
ipcMain.handle("discover-photos", async (_, folderPath) => {
  try {
      ...
      uniqueFiles.map(async (filePath) => {
        try {
          ...
          return {
            ...
            directory: path$1.dirname(filePath)
          };
        } catch (error) {
