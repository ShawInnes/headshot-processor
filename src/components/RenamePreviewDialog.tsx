...
import {NamingSettings, RenameOperation, RenamePreview} from '../types/renaming'
                ...
                <div className="space-y-4">
                    ...
                    {preview.conflicts.length > 0 && (
                        <Alert>
                            ...
                            <AlertDescription>
                                {preview.conflicts.length} naming conflicts detected and automatically resolved by
                                            ...
                                            return (
                                                <div key={photo.path}
                                                    ...
                                                    <div className="flex-1">
                                                        <div
                                                            className="font-mono text-gray-600">{operation.originalName}</div>
                                                        {needsRename ? (
                                                            <div className="flex items-center gap-2">
                                                                <span className="text-gray-400">→</span>
                                                                <div
                                                                    className={`font-mono ${hasConflict ? 'text-orange-600' : 'text-green-600'}`}>
                                                                    {operation.newName}
                                                                </div>
                                                                {hasConflict && (
